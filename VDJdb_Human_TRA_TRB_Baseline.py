...
df = pd.read_csv("VDJdb_Human_TRA_TRB_Baseline_Input.csv" , sep="\t")
...
plt.title("TRBV Gene Usage in Human-specific TCRs")
plt.ylabel("Count")
plt.savefig("human image/TRBV Gene Usage in Human-specific TCRs.png")
plt.show()
...
plt.title("CDR3 Length Distribution (Human)")
plt.savefig("human image/CDR3 Length Distribution (Human).png")
plt.show()
...
plt.savefig("human image/Motif Distribution (CASS endings)in Human-specific TCRs.png")
plt.show()
...
plt.savefig("human image/Heatmap of TRBV vs CDR3b Length in Human-specific TCRs.png")
plt.show()
...
plt.savefig("human image/CDR3b Length Distribution by TRBV Gene (box Plot) in Human-specific TCRs.png")
plt.show()
...
plt.ylabel("CDR3b Length")
plt.xlabel("TRBV Gene")
plt.savefig("human image/CDR3b Length Distribution by TRBV Gene (Violin Plot) in Human-specific TCRs.png")
plt.show()
...
plt.ylabel("TRBV Gene")
plt.savefig("human image/Heatmap of TRBV vs CDR3b Motifs in Human-specific TCRs.png")
plt.show()
...
plt.ylabel("Motif")
plt.xlabel("TRBV Gene")
plt.savefig("human image/Motif Distribution by TRBV Gene (box Plot) in Human-specific TCRs.png")
plt.show()
...
plt.ylabel("Motif")
plt.xlabel("TRBV Gene")
plt.savefig("human image/Motif Distribution by TRBV Gene (Violin Plot) in Human-specific TCRs.png")
plt.show()
